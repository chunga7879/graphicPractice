...
loadAndPlaceOBJ('gltf/armadillo.obj', shadowMaterial, function(armadilloShadow) {
  armadilloShadow.position.set(0.0, 4.0, 6.0);
  armadilloShadow.scale.set(0.075, 0.075, 0.075);
  armadilloShadow.parent = worldFrame;
...
// // sphere for testing
// const sphereGeometry = new THREE.SphereGeometry(5.0, 32.0, 32.0);
// const sphere = new THREE.Mesh(sphereGeometry, envmapMaterial);
// sphere.position.set(0.0, 4.0, 6.0);
// sphere.parent = worldFrame;
// scene.add(sphere);
//
// // sphere for testing shadow
// // const sphereGeometry = new THREE.SphereGeometry(5.0, 32.0, 32.0);
// const sphereShadow = new THREE.Mesh(sphereGeometry, shadowMaterial);
// sphereShadow.position.set(0.0, 4.0, 6.0);
// // sphereShadow.parent = worldFrame;
// shadowScene.add(sphereShadow);
...
function update() {
  ...
  else if (sceneHandler == 3) 
  {
    ...
    floorMaterial.uniforms.textureSize.value = screenSize.width;
