...
const squareColor = { type: 'c', value: new THREE.Color(0.1, 1.0, 1.0) };
const squareColor2 = { type: 'c', value: new THREE.Color(0xf603a3) };
...
// let mode = shaders.PHONG.key; // Default 1a, 1b
// let mode = shaders.TOON.key; // 1c
let mode = shaders.SQUARES.key; // 1d
